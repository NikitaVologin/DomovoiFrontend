	...
	<main class="content-width">
		<div class="search-head">
			<div class="search-head__tabs">
				<div class="search-head__tabs__item" :class="headTabItemClass('filters')" @click="head.expandedTab = 'filters'">
				...
				<div class="search-head__tabs__item" :class="headTabItemClass('map')" @click="head.expandedTab = 'map'">
			...
			<div class="search-head__card card search-head__card_filters" v-if="head.expandedTab == 'filters'">
...
export default defineComponent({
	components: { Header, AnnouncementCard },
	data() {
		return {
			head: {
				expandedTab: "filters" as TabName|null,
				filters: {
	...
	methods: {
		headTabItemClass(tab:TabName) {
			let arr = [];
			if (tab == this.head.expandedTab) arr.push("search-head__tabs__item_expanded");
			return arr;
		},
	}
})
